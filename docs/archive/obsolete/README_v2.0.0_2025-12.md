> ⚠️ **DOCUMENT ARCHIVÉ**
> **Statut :** Obsolète (renommé `README_v2.0.0_2025-12.md`)
> **Date d'archivage :** 2026-05-31
> **Raison :** Index de la documentation pointant vers la version 2.0.0 (datée décembre 2025) alors que le projet est en version 2.2.0. Mentionne uniquement les guides historiques sans inclure les rapports de qualité, valorisation, audit cabinet et commissaire aux apports produits depuis. Risque d'orienter un nouvel arrivant vers un sous-ensemble incomplet de la documentation.
> **Remplacé par :** `docs/README.md` (nouvel index actif daté du 2026-05-31, qui distingue documentation active et archive).
